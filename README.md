...
```
$ git clone https://github.com/snykk/transaction-api.git
...
This project is licensed under the MIT License. See the [LICENSE](https://github.com/snykk/transaction-api/blob/master/LICENSE) file for details.
